                ...
                <ul class="nav nav-tabs nav-stacked menu">
                    ...
                    <div  style="background-color: #f5f5f5;   border: 1px solid #eee; border: 1px solid rgba(0, 0, 0, 0.05);" >
                        <ul id="Mpemohon" class="submenu collapse in">
                            <li><a href="?op=pemohon&act=add"><i class="icon-plus-sign"></i>&nbsp; input pemohon</a></li>
                            <li><a href="?op=tpemohon"><i class="icon-search"></i> &nbsp;lihat pemohon</a></li>     
                        </ul>
                    </div>
                    <li><a href="#" data-toggle="collapse" data-target="#Mgrouppemohon"><i class="icon-list-alt"></i>&nbsp;&nbsp;<b>Group Pemohon</b></a></li>
                    <div  style="background-color: #f5f5f5;   border: 1px solid #eee; border: 1px solid rgba(0, 0, 0, 0.05);" >    
                        <ul id="Mgrouppemohon" class="submenu collapse in">
                            <li ><a href="?op=grouppemohon&act=add"><i class="icon-plus-sign"></i>&nbsp; input group pemohon</a></li>
                            <li ><a href="?op=tgrouppemohon"><i class="icon-search"></i> &nbsp;lihat group pemohon</a></li>                    
                        </ul>
                    </div>
                    ...
                    <li><a href="#" data-toggle="collapse" data-target="#Mgrouptransaksi"><i class="icon-list-alt"></i>&nbsp;&nbsp;<b>Group Transaksi</b></a></li>
                    <div  style="background-color: #f5f5f5;   border: 1px solid #eee; border: 1px solid rgba(0, 0, 0, 0.05);" >    
                        <ul id="Mgrouptransaksi" class="submenu collapse in">
                            <li ><a href="?op=grouptransaksi&act=add"><i class="icon-plus-sign"></i>&nbsp; input group transaksi</a></li>
                            <li ><a href="?op=tgrouptransaksi"><i class="icon-search"></i> &nbsp;lihat group transaksi</a></li>                    
                        </ul>
                    </div>
                </ul>
        </div>
